...
The tool is a wrapper that triggers tests that run in containers taken from `rackpart <https://rakpart.testthedocs.org/>`_, and those containers generate output.
...
You can find other ideas `in our issue queue <https://github.com/testthedocs/redactor/issues/>`_.
